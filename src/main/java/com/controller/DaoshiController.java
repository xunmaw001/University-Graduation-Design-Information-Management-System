...
public class DaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DaoshiEntity u = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("daoshigonghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(u.getId(), username,"daoshi",  "导师" );
    ...
    public R register(@RequestBody DaoshiEntity daoshi){
    	...
    	DaoshiEntity u = daoshiService.selectOne(new EntityWrapper<DaoshiEntity>().eq("daoshigonghao", daoshi.getDaoshigonghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        DaoshiEntity u = daoshiService.selectById(id);
