	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="答辩成绩" prop="dabianchengji">
					<el-input v-model="ruleForm.dabianchengji" placeholder="答辩成绩" clearable  :readonly="ro.dabianchengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="答辩成绩" prop="dabianchengji">
					<el-input v-model="ruleForm.dabianchengji" placeholder="答辩成绩" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="答辩结果" prop="dabianjieguo">
					<el-select :disabled="ro.dabianjieguo" v-model="ruleForm.dabianjieguo" placeholder="请选择答辩结果" >
						<el-option
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="答辩结果" prop="dabianjieguo">
					<el-input v-model="ruleForm.dabianjieguo"
						placeholder="答辩结果" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="学号" prop="xuehao">
					<el-input v-model="ruleForm.xuehao" placeholder="学号" clearable  :readonly="ro.xuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="评分时间" prop="pingfenshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.pingfenshijian" label="评分时间" prop="pingfenshijian">
					<el-input v-model="ruleForm.pingfenshijian" placeholder="评分时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="答辩评价" prop="dabianpingjia">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.dabianpingjia" label="答辩评价" prop="dabianpingjia">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.dabianpingjia"></span>
                </el-form-item>
...
export default {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='dabianchengji'){
							...
							this.ro.dabianchengji = true;
							continue;
						}
						if(o=='dabianjieguo'){
							this.ruleForm.dabianjieguo = obj[o];
							this.ro.dabianjieguo = true;
							continue;
						}
						if(o=='dabianpingjia'){
							this.ruleForm.dabianpingjia = obj[o];
							this.ro.dabianpingjia = true;
							continue;
						}
						if(o=='daoshigonghao'){
	...
	this.ruleForm.dabianpingjia = this.ruleForm.dabianpingjia.replace(reg,'../../../ssm22t68/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dabianchengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dabianchengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
