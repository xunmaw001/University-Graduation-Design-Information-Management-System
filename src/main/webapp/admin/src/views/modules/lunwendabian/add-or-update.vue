	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="upload" v-if="type!='info'&& !ro.dabianppt" label="答辩ppt" prop="dabianppt">
					<file-upload
						tip="点击上传答辩ppt"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.dabianppt" label="答辩ppt" prop="dabianppt">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(198, 205, 214, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.dabianppt)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="!ruleForm.dabianppt" label="答辩ppt" prop="dabianppt">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="答辩时间" prop="dabianshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.dabianshijian" 
						type="date"
						:readonly="ro.dabianshijian"
						placeholder="答辩时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.dabianshijian" label="答辩时间" prop="dabianshijian">
					<el-input v-model="ruleForm.dabianshijian" placeholder="答辩时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	if(this.ruleForm.dabianppt!=null) {
		this.ruleForm.dabianppt = this.ruleForm.dabianppt.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lunwendabian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lunwendabianCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    dabianpptUploadChange(fileUrls) {
	    this.ruleForm.dabianppt = fileUrls;
    },
  }
};
</script>
