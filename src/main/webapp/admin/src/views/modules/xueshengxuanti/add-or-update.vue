	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="选择原因" prop="xuanzeyuanyin">
					<el-input v-model="ruleForm.xuanzeyuanyin" placeholder="选择原因" clearable  :readonly="ro.xuanzeyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="选择原因" prop="xuanzeyuanyin">
					<el-input v-model="ruleForm.xuanzeyuanyin" placeholder="选择原因" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="选择时间" prop="xuanzeshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.xuanzeshijian" 
						type="date"
						:readonly="ro.xuanzeshijian"
						placeholder="选择时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xuanzeshijian" label="选择时间" prop="xuanzeshijian">
					<el-input v-model="ruleForm.xuanzeshijian" placeholder="选择时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="专业" prop="zhuanye">
					<el-input v-model="ruleForm.zhuanye" placeholder="专业" clearable  :readonly="ro.zhuanye"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="专业" prop="zhuanye">
...
export default {
	...
	created() {
		this.ruleForm.xuanzeshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xuanzeyuanyin'){
							this.ruleForm.xuanzeyuanyin = obj[o];
							this.ro.xuanzeyuanyin = true;
							continue;
						}
						if(o=='xuanzeshijian'){
							this.ruleForm.xuanzeshijian = obj[o];
							this.ro.xuanzeshijian = true;
							continue;
						}
						if(o=='xuehao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xueshengxuanti/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xueshengxuantiCrossAddOrUpdateFlag = false;
						 this.parent.search();
