	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="指导时间" prop="zhidaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.zhidaoshijian" label="指导时间" prop="zhidaoshijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="修改内容" prop="xiugaineirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.xiugaineirong" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.xiugaineirong" label="修改内容" prop="xiugaineirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xiugaineirong"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.zhidaoshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xiugaineirong'){
							this.ruleForm.xiugaineirong = obj[o];
							this.ro.xiugaineirong = true;
							continue;
						}
						if(o=='zhidaoshijian'){
	...
	this.ruleForm.xiugaineirong = this.ruleForm.xiugaineirong.replace(reg,'../../../ssm22t68/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lunwenzhidao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lunwenzhidaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
